...
public class Ex_13 {
	...
	public static void main(String[] args) {
		List<Employee> empList = Arrays.asList(new Employee(101, "suneel", 35000), new Employee(102, "Praveen", 45000),
				...
				new Employee(105, "Akbar", 27000), new Employee(106, "Balu", 42600), new Employee(107, "Deepak", 22500));
...
//		empList.stream().distinct().sorted(Comparator.comparingDouble(Employee::getSalary).reversed()).limit(3).forEach(System.out::println);
		...
		empList.stream().sorted(Comparator.comparingDouble(Employee::getSalary).reversed().thenComparing(Employee::getName)).forEach(System.out::println);
	}
